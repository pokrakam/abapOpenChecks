"! <p class="shorttext synchronized" lang="en">102 - Meaningful constant names</p>
"! Constants should have meaningful names rather than just repeating their content
"!
"! The following checks can be carried out on constant names
"! 1) Numbers are not permitted (e.g. c_01).
"! 2) Constant name = content ( e.g. CONSTANTS c_or TYPE auart VALUE 'OR'. )
"! 3) Name excluding prefix should be more than n characters (default 2)
